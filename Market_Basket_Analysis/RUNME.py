...
# MAGIC ```
# MAGIC
# MAGIC Don't forget to accept the [Terms](https://www.kaggle.com/competitions/instacart-market-basket-analysis/data) of the challenge. 
...
job_json = {
        ...
        "tasks": [
            ...
            {
                "job_cluster_key": "market_basket_cluster",
                "notebook_task": {
                    "notebook_path": f"01_Configuration"
                },
                "task_key": "market_basket_01"
            },
            {
                "job_cluster_key": "market_basket_cluster",
                "notebook_task": {
                    "notebook_path": f"02_Data Preparation"
                },
                "task_key": "market_basket_02",
                "depends_on": [
                    {
                        "task_key": "market_basket_01"
                    }
            ...
            },
            {
                "job_cluster_key": "market_basket_cluster",
                "notebook_task": {
                    "notebook_path": f"03_Generate Rules"
                },
                "task_key": "market_basket_03",
                "depends_on": [
                    {
                        "task_key": "market_basket_02"
                    }
            ...
            },
            {
                "job_cluster_key": "market_basket_cluster",
                "notebook_task": {
                    "notebook_path": f"04_Make Recommendations"
                },
                "task_key": "market_basket_04",
                "depends_on": [
                    {
                        "task_key": "market_basket_03"
                    }
