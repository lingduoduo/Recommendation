...
def train_and_evaluate(local_click_path_file, local_item_path_file, local_user_path_file):
    """
    Args:
        local_click_path_file: user rating CSV file with columns: user_id, item_id, rating
        local_item_path_file: item rating CSV file with columns: item_id, title
        local_user_path_file: user rating CSV file with columns: user_id, last_user_agent
    Returns:
        None
    """
    ...
    for epoch in range(num_epochs):
        ...
        p, r, acc = compute_evaluation_metrics(y_pred, y_true)
